        ...
        <div>
            <form method="post" action="<c:url value="/creationCommande"/>">
                ...
                <fieldset>
                    ...
                    <span class="erreur">${form.errors['dateCommande']}</span>
                    <br />
                    ...
                    <span class="erreur">${form.errors['montantCommande']}</span>
                    <br />
                    ...
                    <span class="erreur">${form.errors['modePaiementCommande']}</span>
                    <br />
                    ...
                    <span class="erreur">${form.errors['statutPaiementCommande']}</span>
                    <br />
                    ...
                    <span class="erreur">${form.errors['modeLivraisonCommande']}</span>
                    <br />
                    ...
                    <span class="erreur">${form.errors['statutLivraisonCommande']}</span>
                    <br />
                </fieldset>
